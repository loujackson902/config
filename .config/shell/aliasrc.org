...
#+PROPERTY: header-args :tangle /home/benny/.aliasrc
#+auto_tangle: t
...
kee="keepassxc-cli open $HOME/documents/kee/dbs/things.kdbx -k $HOME/documents/kee/keez/.foxy.key" \
build_grub="sudo grub-mkconfig -o /boot/grub/grub.cfg" \
emacsd="emacs --bg-daemon"\
...
* xfce
A more simplistic command for initializing xfce
#+begin_src sh
alias \
    xfce="startxfce4"
#+end_src
